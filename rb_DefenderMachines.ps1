...
$containerName = Get-AutomationVariable 'defendermachines' # Container name
...
$report = Get-DefenderMachines 

Write-Host "Running report..." -f Cyan

$report | Export-Csv -Path 'defendermachines.csv' -NoTypeInformation -Force
...
Set-AzStorageBlobContent -Container $ContainerName -File defendermachines.csv -Blob defendermachines.csv -Force
